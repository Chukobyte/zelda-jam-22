...
class RoomModel:
    INITIAL_DATA = {
        ...
        Vector2.ZERO(): RoomData(
            ...
            # right_door_status=DoorState.CRACKED_OPEN_WALL,
            right_door_status=DoorState.BREAKABLE_WALL,
        ...
        Vector2.RIGHT(): RoomData(
            left_door_status=DoorState.CRACKED_OPEN_WALL,
            right_door_status=DoorState.SOLID_WALL,
